...
st.write(
    ...
    f"Military: {military_spending}%, Education: {education_spending}%, Health: {health_spending}%"
)
...
if st.button("Test Policy Set"):
    ...
    # Here, you might want to modify the API calls to include these new values if your backend supports them.
